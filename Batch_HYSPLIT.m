%% Setup locations
clc;
Location = ["Mersing","Tasik Kenyir"];
Location = arrayfun(@(x) regexprep(x, '[^a-zA-Z]', ''),Location);
Lat = [2.43,5.0040] ;
Lon = [103.84,105.0040];
Time = [datetime(2011,3,14)];
Period = 24*7;
NewData = [];
...
writetable(EmissionTable,"TeradaEmission.txt","Delimiter"," ");
...
for l = 1:numel(Location)
    for t = 1:numel(Time)
        ...
        batchCommands = ["@echo off";...
            ...
            "echo !SA!";...
            "echo !SB!";...
            "    echo 11 03 !DAY! !HOUR!            >CONTROL";...
            "    echo 2                       >>CONTROL";...
            sprintf("    echo %.2f %.2f 1.0    >>CONTROL",Lat(l),Lon(l));...
            sprintf("    echo %.2f %.2f 100.0    >>CONTROL",Lat(l),Lon(l));...
            "echo !RUN!"
            "    echo !RUN!                   >>CONTROL";...
            "    echo 0                       >>CONTROL";...
            ...
            "    echo 4                       >>CONTROL";...
            "    echo ./                      >>CONTROL";...
            "    echo gdas1.mar11.w2         >>CONTROL";...
            "    echo ./                      >>CONTROL";...
            "    echo gdas1.mar11.w3         >>CONTROL";...
            "    echo ./                      >>CONTROL";...
            "    echo gdas1.mar11.w4         >>CONTROL";...
            "    echo ./                      >>CONTROL";...
            "    echo gdas1.mar11.w5         >>CONTROL";...
            "    echo 2                       >>CONTROL";...
            "    echo RNUC                    >>CONTROL";...
            "    echo 1.0                     >>CONTROL";...
            "    echo !RUN!                     >>CONTROL";...
            ...
            "rem ---------------------------------------------";...
            "  ";...
            "%PGM%\exec\condecay -1:1:11025.8:C137 -2:1:8.02330:I131 +eTeradaEmission +oCG_ +t031106";...
            " ";...
            "for /F ""tokens=1,2,3,4,5"" %%A in (Allday.txt) do (";...
            "set DAY=%%C";...
            "set HOUR=%%D";...
